...
public class SignIn extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/encrypted-phone.png"))); // NOI18N
        jPanel3.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 50, 620, 560));

        jLabel2.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(118, 171, 174));
        jLabel2.setText("JDEV");
        jPanel3.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 10, -1, -1));

        getContentPane().add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 680, 600));

        jPanel1.setBackground(new java.awt.Color(49, 54, 63));
        jPanel1.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        exitBtn.setBackground(new java.awt.Color(255, 255, 255));
        exitBtn.setFont(new java.awt.Font("Tw Cen MT Condensed Extra Bold", 1, 35)); // NOI18N
        ...
        jPanel1.add(exitBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 0, -1, -1));
        ...
        jLabel4.setText("PLEASE LOGIN TO ADMIN DASHBOARD");
        jPanel1.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 120, 520, -1));

        jLabel5.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(255, 255, 255));
        jLabel5.setText("__________________________________________________");
        jPanel1.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 300, 340, -1));

        usernameInp.setBackground(new java.awt.Color(49, 54, 63));
        usernameInp.setForeground(new java.awt.Color(238, 238, 238));
        usernameInp.setBorder(null);
        jPanel1.add(usernameInp, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 220, 300, 20));
        ...
        jPanel1.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 230, 340, -1));
        ...
        passInp.setBackground(new java.awt.Color(49, 54, 63));
        passInp.setForeground(new java.awt.Color(238, 238, 238));
        ...
        jPanel1.add(passInp, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 290, 300, 20));
        ...
        jPanel1.add(viewPassword, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 330, -1, -1));

        loginBtn.setBackground(new java.awt.Color(73, 171, 174));
        ...
        jPanel1.add(loginBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 370, 310, 40));

        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(680, 0, 520, 600));
    ...
    private void loginBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loginBtnActionPerformed
        //TEMPORARY VALUE FOR LOGIN ACCOUNT
        String username = "admin";
        String password = "admin123";
        
        String user = usernameInp.getText();
